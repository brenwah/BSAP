...
opts.randomGenerator = 1; % 0 = subject input, 1 = random response
...
tk.step_size = [16 8 4 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2]; % step size
tk.max_reversals = [10 10]; % max num reversals for each track
tk.max_trials = [5 15]; % max trials for each track
